...
static const X_GPIO_T s_gpio_list[HARD_KEY_NUM] = {
	{LIMIT0_GPIO_Port, LIMIT0_Pin,  0},			/* K1 */	             // DATA11[0]     方
	{LIMIT1_GPIO_Port, LIMIT1_Pin,  0},			/* K2 */	             // DATA11[1]     叉
	{LIMIT2_GPIO_Port, LIMIT2_Pin,  0},			/* K3 */                 // DATA11[2]     圆
 	 {LIMIT3_GPIO_Port, LIMIT3_Pin,  0},		/* K4 */                 // DATA11[3]    三角
	{LIMIT4_GPIO_Port, LIMIT4_Pin,  0},			/* K5 */	             // DATA11[0]     方
	{LIMIT5_GPIO_Port, LIMIT5_Pin,  0},			/* K6 */	             // DATA11[1]     叉
	{LIMIT6_GPIO_Port, LIMIT6_Pin,  0},			/* K7 */                 // DATA11[2]     圆
  	{LIMIT7_GPIO_Port, LIMIT7_Pin,  0},			/* K8 */                 // DATA11[3]    三角
//	{LIMIT8_GPIO_Port, LIMIT8_Pin,  0},			/* K9 */	             // DATA11[0]     方
	{LIMIT9_GPIO_Port, LIMIT9_Pin,  0},			/* K10 */	             // DATA11[1]     叉
};	
...
void bsp_KeyScan10ms(void)
{
	...
	for(uint32_t j = 0 ; j < HARD_KEY_NUM; j++)
	{
		key_read[j] = bsp_GetKeyState(j);
		key = key + (key_read[j] << j);
	}
}
...
/* void bsp_RunPer100ms(void)
{
	...
	angle_as5048b_f=as5048b10.angle_f-as5048b10.angle_f_pre>0?as5048b10.angle_f-as5048b10.angle_f_pre:as5048b10.angle_f+360.0-as5048b10.angle_f_pre;
	speed=angle_as5048b_f*10.0*60/360.0;
