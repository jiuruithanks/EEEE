...
uint8_t  UART3_Rx_flg;
uint32_t UART3_Rx_cnt;
uint32_t UART3_Rx_Buf_reg[MAX_REC_LENGTH]; //USART3存储接收数据

unsigned char delete_esc_data[64];
uint8_t g_insert_esc_data[64];
/* USER CODE END 0 */
